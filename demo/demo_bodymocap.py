    ...
    while True:
        ...
        if input_type =='image_dir':
            if cur_frame < len(input_data):
                ...
                #new_pkl_dir = "/data/Self-Correction-Human-Parsing/ccvr_mid_store_all_pkl_1"
                #pkl_filename = os.path.basename(save_path)
                #sample_pkl_filename = os.path.basename(sample_save_path)
                #check_save_path = os.path.join(new_pkl_dir, pkl_filename)
                #check_sample_save_path = os.path.join(new_pkl_dir, sample_pkl_filename)
                #if os.path.exists(check_save_path) and os.path.exists(check_sample_save_path):
                #    cur_frame += 1
                #    continue
        ...
        pred_output_list = body_mocap.regress(img_original_bgr, body_bbox_list, image_path)
